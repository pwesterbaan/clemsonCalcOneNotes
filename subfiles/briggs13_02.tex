...
\section{13.2: Vectors in Three Dimensions}~
  ...
  \textbf{Distances in $xyz$-Space:}\newline
    ...
    \end{center}
    \vspace*{\stretch{1}}
    \begin{thmBox*}[Distance Formula in $xyz$-Space]
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.0]
      \begin{axis}[
        ...
        zmin=-0.5, zmax=3.5, zmajorticks=false,
        ...
        \addplot3[fill=ClemsonPurple!75, opacity=0.5, draw=none]
          ...
          node[above, black, pos=0.285, pin={[pin distance=22.5pt]-75:{}}, 
          xshift=-2.5pt, yshift=20pt, font=\footnotesize, fill=white, 
          opacity=0.75, inner sep=1pt, text opacity=1, yshift=12pt] 
          {$\abs{\overrightharp{PQ}}=\sqrt{\parens{x_2-x_1}^2+\parens{y_2-y_1}^2+\parens{z_2-z_1}^2}$};
        \addplot3[black, ->] 
  ...
  \begin{thmBox*}[Properties of Vector Operations:]
